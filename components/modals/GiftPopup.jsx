...
const GiftPopup = ({ dispatch, changePopup }) => {
  return (
    <AnimatePresence>
      <motion.div
        key="survey"
        ...
        >
          <div className="py-5 px-10 flex flex-col gap-2.5 items-center text-center relative">
            <button
              ...
              className="absolute top-5 left-4 text-lg lg:text-xl p-0.5 lg:p-1 border-2 border-black flex items-center justify-center rounded-full hover:text-white hover:bg-black transition-all duration-300 ease-in-out"
            >
              <IoMdClose />
            </button>
