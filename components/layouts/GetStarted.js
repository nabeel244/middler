      ...
      <div className="container">
        <div className="row justify-center gap-y-[50px]">
          ...
          <div className="w-full">
            <div className="grid w-full max-lg:grid-cols-1 max-lg:gap-y-10">
                ...
                <div className="flex justify-center max-lg:w-full">
                  <div className="relative max-lg:min-h-[569px] max-lg:w-full">
                    <img
                      ...
                      className="max-w-[600px] max-lg:absolute left-1/2 max-lg:-translate-x-1/2"
                      alt=""
                    />
                    {[
                      ...
                      <div
                        key={idx}
                        className={`absolute z-[2] flex items-center justify-center px-3 lg:px-7 py-2 lg:py-3.5 gap-[7] bg-[rgba(255,255,255,0.32)] lg:bg-[rgba(0,0,0,0.095)] backdrop-blur-[36px] shadow-[0_3.75px_5.95px_rgba(0,0,0,0.12)] rounded-lg ${idx === 0
                      ...
                      >
                        ...
                        <span className="text-[8px] whitespace-nowrap lg:text-[15.8px]">{item}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="max-lg:px-5 lg:col-start-1 lg:-col-end-1 lg:row-start-1 lg:-row-end-1 flex max-lg:flex-wrap justify-between items-end relative z-[1]">
                ...
                <div className="lg:w-[28%] flex flex-col gap-10 max-lg:order-1">
                  {[
                    ...
                    <div key={idx} className="flex flex-col lg:flow-row gap-5 lg:gap-x-3.5 max-lg:border-b border-b-primary-400 max-lg:pb-2">
                      <img
