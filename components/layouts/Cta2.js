            ...
            <div className="flex flex-col-reverse  max-lg:gap-y-10 lg:flex-row text-center lg:text-left items-center justify-between">
              ...
              <div className="w-full max-w-[800px] flex-col flex gap-10">
                ...
                <p className="text-[11px] lg:text-2xl">
                  Level up your next home project with Middler, the smart
                  estimating tool built for everyone. Whether you're planning
                  interiors, exteriors, or full renovations, Middler helps you
                  create fast, accurate, and professional estimates—every single
                  time.
                </p>
                <p className="text-[11px] lg:text-2xl">
