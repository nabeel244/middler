          ...
          <div className="row">
            <div>
              <div className=" flex items-center justify-center dark:text-black">
                <div className="bg-white rounded-lg shadow-[0_0_10px] shadow-black/10 p-8 w-full">
                  <h1 className="text-3xl font-bold mb-4">
                    TERMS of SERVICE AND CONDITIONS & TERMS OF USE
                  </h1>
                  ...
                  <p className="mb-4">
                    ...
                    are solely responsible for compliance with any and all
                    Local, State, Federal, international, Internet and
                    Applicable Law(s).
                  </p>
                  <p className="mb-4">
                    The Site is intended for users who are at least 18 years
                    old. Persons under the age of 18 are not permitted to use or
                    register for the Site. Unless otherwise indicated, the Site
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      ...
                      any illegal or unauthorized purpose, and (7) your use of
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      You may be required to register, sign up and or sign in
                      with the Site. You agree to keep your password
                      ...
                      in our sole discretion, that such username is
                  ...
                  <section className="mt-8">
                    ...
                    <ol className="list-decimal list-inside mb-4 space-y-2">
                      ...
                      <li>
                        ...
                        information such as user passwords, contact information,
                        and or addresses of any kind.
                      </li>
                      <li>
                        Circumvent, disable, or otherwise interfere with
                        security-related features of the Site, including
                        features that prevent or restrict the use of copying of
                      ...
                      <li>
                        Use the Site in a manner inconsistent with any and all
                        applicable local laws, state laws, internet laws,
                        federal laws, or any other governing laws and
                        regulations.
                      </li>
                      <li>
                      ...
                      <li>
                        Except as permitted by applicable law, decipher, decode,
                  ...
                  <section className="mt-8">
                    ...
                    <ul className="list-disc list-inside mb-4 space-y-2">
                      ...
                      <li>
                        ...
                        advertising, promotional schemes, chain letters, spam,
                        mass mailings, or other forms of solicitation.
                      </li>
                      <li>
                        Your Contributions are not obscene, lewd, lascivious,
                        violent, harassing, bullying, menacing, or otherwise
                        objectionable (as determined by us).
                      </li>
                      <li>
                        Your Contributions do not ridicule, mock, disparage,
                        intimidate, or abuse anyone, nor do they promote
                      ...
                      <li>
                        ...
                        protect the health or well-being of minors. Absolutely
                        no content of minors may be published, displayed, or in
                        any way featured or used on Middler.com.
                      </li>
                      <li>
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      ...
                      making Contributions accessible to the Site by linking
                      your account from the Site to any of your social
                      ...
                      display, reformat, translate, transmit, excerpt (in whole
                      or in part), and distribute such Contributions (including,
                  ...
                  <section className="mt-8">
                    ...
                    <ol className="list-decimal list-inside mb-4">
                      ...
                      <li>
                        ...
                        abusive racist, offensive, and/or hate language.
                      </li>
                      <li>
                      ...
                      <li>
                        You should not be affiliated with competitors of the
                        person/entity being reviewed.
                      </li>
                      <li>
                    ...
                    <p className="mb-4">
                      ...
                      reviews or to delete reviews that anyone considers
                      objectionable or inaccurate. Reviews are not endorsed by
                      us and do not necessarily represent our opinions or the
                      views of any of our affiliates or partners. We do not
                      assume liability for any review or for any claims,
                      liabilities, or losses resulting from any review.
                    </p>
                    <p className="mb-4">
                      By posting a review, you hereby grant us a perpetual,
                      non-exclusive, worldwide, royalty-free, fully-paid,
                      assignable, and sublicensable right to reproduce, modify,
                  ...
                  <section className="mt-8">
                    ...
                    <h3 className="text-md font-semibold mb-2">Use License</h3>
                    <p className="mb-4">
                    ...
                    <ol className="list-decimal list-inside mb-4">
                      ...
                      <li>
                        ...
                        any applications, accessories, or devices for use with
                        the application.
                      </li>
                    </ol>
                  </section>
                  ...
                  <section className="mt-8">
                    ...
                    <ol className="list-decimal list-inside mb-4">
                      ...
                      <li>
                        ...
                        as specified in the terms and conditions of this mobile
                        application license contained in these Terms of Use or
                        as otherwise required under all applicable law, and you
                      ...
                      <li>
                        ...
                        of Use, and that each App Distributor will have the
                  ...
                  <section className="mt-8">
                    ...
                    <ol className="list-decimal list-inside mb-4">
                      ...
                      <li>
                        We may submit to and receive from your Third-Party
                    ...
                    <p className="mb-4">
                      ...
                      the Social Network Content may no longer be available on
                  ...
                  <section className="mt-8">
                    <h2 className="text-lg font-semibold mb-2">ADVERTISERS</h2>
                    <p className="mb-4">
                    ...
                    <p className="mb-4">
                      ...
                      contractual rights. As an advertiser, you agree that such
                      advertisements are subject to our Digital Millennium
                      Copyright Act (DMCA) Notice and Policy provisions as
                      described below, and you understand and agree there will
                      be no refund or other compensation for DMCA
                      takedown-related issues.
                    </p>
                    <p>
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      ...
                      Privacy Policy:{" "}
                      <a
                        href={process.env.NEXT_PUBLIC_SITE_URL_PROD}
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      ...
                      the Site infringes your copyright, you should consider
                    ...
                    <ol className="list-decimal ml-8 mb-4">
                      ...
                      <li>
                        ...
                        Site are covered by the Notification, a representative
                  ...
                  <section className="mt-8">
                    ...
                    <p className="font-semibold">
                      Designated Copyright Agent at Support@middler.com Attn:
                      Copyright Agent
                    </p>
                  </section>
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SITE OR
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      ...
                      by and construed in accordance with the law, applicable to
                      agreements made and to be entirely performed within the
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      ...
                      in California. Except as otherwise provided herein, the
                    ...
                    <p className="mb-4">
                      ...
                      in the state and federal courts located in California, and
                    ...
                    <p>
                      ...
                      (1) year after the cause of action arose. If this
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      ...
                      invasion of privacy, or unauthorized use; and (c) any
                      claim for injunctive relief. If this provision is found to
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      ...
                      AT ALL TIMES BE LIMITED TO THE LESSER OF THE AMOUNT PAID,
                      IF ANY, BY YOU TO US DURING THE ONE (1) MONTH PERIOD PRIOR
                      TO ANY CAUSE OF ACTION ARISING OR $1.00 USD. CERTAIN US
                      ...
                      YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS. MIDDLER.COM,
                      MIDDLER, MIDDLER’S AFFILIATES, SUBSIDIARIES, PARTNERS,
                      PARENT COMPANIES, AFFILIATED LLCs, CORPORATIONS, OWNER(S),
                      INVESTORS, BOARD MEMBERS AND OR ANY OTHER MEMBER OF
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      Middler may at times use independent associates,
                      employees, and other staff which must adhere to all laws.
                      These laws include but are not limited to local, state,
                      federal, digital laws and regulations. Independent
                      associates, employees, and other staff may have different
                      titles. Independent associates, employees, and other staff
                      do not speak for Middler, cannot make rules, cannot make
                      changes, and have no authority over and or from Middler.
                      Please contact Support@middler.com for clarification.
                      Independent associates, employees, and other staff must
                      never harm, harass, intimidate, or in any way pressure or
                      make anyone uncomfortable in any way. Independent
                      associates, employees, and other staff must never falsify,
                      embellish, exaggerate any information, obligations, or any
                      and all warranties or guarantees for or about Middler or
                      its affiliates including any and all staff. Middler makes
                      no warranties and or guarantees to independent associates,
                      employees, and other staff or any users of Middler.com.
                      Independent associates, employees, and other staff agree
                      that all things learned, connections made, and any and all
                      intellectual rights belong to Middler. Middler may
                      terminate independent associates, employees, and other
                      staff at any time with or without notice if any portion of
                      the Middler Terms of Service or Privacy Policies is not
                      adhered to. Middler is held harmless and not liable for or
                      from any and all actions of independent associates,
                      employees, and other staff. Independent associates,
                      employees, and other staff are responsible for their own
                      actions.
                    </p>
                    <p className="mb-4">
                      ...
                      information with other users, third parties, and
                      Providers.
                    </p>
                    <p className="mb-4">
                      ...
                      does not express the opinions, suggestions, obligations,
                      and or views in any way of Middler.com, its subsidiaries,
                      affiliates, owners, investors, and all of our respective
                      officers, agents, and or partners. Any communication on
                      the Site does not constitute any obligations by any and
                      all Users or Middler. Nor does any communication on the
                      site constitute a binding agreement.
                    </p>
                    <p className="mb-4">
                      Users of the Site are responsible to conduct their own due
                      diligence, investigation, and vetting before engaging in
                      any activity on or off the site. For safety purposes,
                      Users of the Site should always investigate any and all
                      people, Clients, companies, workers of any kind, and
                      Providers before engaging with them in any and all ways.
                    </p>
                    <p>
                      Middler, and any or all of its affiliates are not
                      responsible to engage in, do or complete any work.
                      Middler’s subsidiaries, affiliates, and all of our
                      respective officers, owners, investors, agents, partners,
                      and employees are not liable, responsible, or bound for
                      any and all action(s) of any and all Users of the Site or
                  ...
                  <section className="mt-8">
                    ...
                    <p className="mb-4">
                      ...
                      receive further information regarding the use of the Site,
                      please contact us at:
                    </p>
                    <p className="mb-2">Middler.com</p>
                    <p>
                      Email:{" "}
                      <a
